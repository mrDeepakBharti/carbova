  ...
  return (
    <div style={{ minHeight: '100vh', background: 'var(--c-bg)', display: 'flex', flexDirection: 'column' }}>
      ...
      <div style={{
        ...
        <div style={{ position: 'absolute', inset: 0, background: 'linear-gradient(to bottom, rgba(8,15,9,0.4), rgba(8,15,9,1))' }} />
      </div>
      ...
      <div style={{ flex: 1, display: 'flex', alignItems: 'center', justifyContent: 'center', padding: '60px 24px' }}>
        <div style={{ textAlign: 'center', maxWidth: 640 }}>
          ...
          <div style={{
            ...
            background: 'var(--gold-dim)', border: '2px solid var(--c-border)',
            display: 'flex', alignItems: 'center', justifyContent: 'center',
            fontSize: 44, margin: '0 auto 32px',
            animation: 'float 3s ease-in-out infinite',
          }}>🔬</div>

          <span className="tag" style={{ justifyContent: 'center', display: 'inline-flex' }}>Innovation & Patents</span>
          ...
          <p style={{ fontSize: 17, color: 'var(--t-b)', lineHeight: 1.8, marginBottom: 48, maxWidth: 480, margin: '0 auto 48px' }}>
            We're working on something exciting. Our Innovation & Patents page — showcasing 12+ patents, R&D breakthroughs, and waste-to-value technologies — will be live very soon.
          </p>
          ...
          <div style={{ display: 'flex', alignItems: 'center', gap: 16, marginBottom: 48, justifyContent: 'center' }}>
            ...
            <span style={{ fontFamily: 'var(--f-mono)', fontSize: 11, color: 'var(--t-dim)', letterSpacing: 3 }}>STAY TUNED</span>
            <div style={{ height: 1, width: 60, background: 'var(--c-border)' }} />
          </div>
